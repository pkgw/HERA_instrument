...
\begin{figure}[h!]
	\centering
	\includegraphics[height=4.0in]{plots/hera_render_logo.pdf}
	\includegraphics[height=4.0in]{plots/hera19H.png}
...
\includegraphics[height=5cm]{plots/elementSizes.pdf}
}
